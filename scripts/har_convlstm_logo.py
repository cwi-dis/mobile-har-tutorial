...
segments = pickle.load(open('segments_90_logo.p','rb'))
labels = pickle.load(open('labels_90_logo.p', 'rb'))
subjects = pickle.load(open('subjects_90_logo.p','rb'))
...
with open("./data/model_had_lstm_logo.json", "w") as json_file:
