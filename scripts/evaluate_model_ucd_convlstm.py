...
model = load_model('model_ucd_lstm.h5')

# load weights into new model
model.load_weights("model_weights_ucd_lstm.h5")
...
test_x = np.load('testData_ucd_lstm.npy')
groundTruth = np.load('groundTruth_ucd_lstm.npy')
